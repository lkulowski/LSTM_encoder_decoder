...
Now, let's evaluate our model performance. We build a LSTM encoder-decoder that takes in 80 time series values and predicts the next 20 values. We use . The specific model parameters that we use are shown below. 
